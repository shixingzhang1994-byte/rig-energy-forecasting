...
"""Materialize the preregistered V26 heterogeneous parameter sets."""
...
FAMILY_PATH = PROJECT_DIR / "configs/v26_heterogeneous_family.yaml"
OUTPUT_ROOT = PROJECT_DIR / "artifacts/V26_heterogeneous_validation/parameter_sets"
...
def materialize(unit: dict, family: dict, calibration_base: dict, dispatch_base: dict) -> dict:
    ...
    calibration["metadata"]["version"] = "V26-heterogeneous-family"
    ...
    calibration["v26_risk_overrides"] = deepcopy(plant["risk_overrides"])
    calibration["v26_unit"] = deepcopy(unit)

    dispatch = deep_merge(dispatch_base, plant["dispatch_overrides"])
    dispatch["metadata"]["version"] = "V26-heterogeneous-family"
