...
"""Freeze the V26 heterogeneous family before any prospective unit outcome."""
...
PROTOCOL = PROJECT_DIR / "configs/v26_heterogeneous_validation.yaml"
FAMILY = PROJECT_DIR / "configs/v26_heterogeneous_family.yaml"
PARAMETER_ROOT = PROJECT_DIR / "artifacts/V26_heterogeneous_validation/parameter_sets"
DEVELOPMENT = PROJECT_DIR / "artifacts/V26_heterogeneous_validation/development/seed_20261100"
...
def main() -> None:
    ...
    if len(prospective) != 12 or len(factors) != 12:
        raise RuntimeError("V26 factor design is not the declared balanced 3x2x2 family")
    ...
    if revealed:
        raise RuntimeError(f"prospective V26 unit directories already exist: {revealed}")
    ...
    implementation.RUNNER_PATHS = [
        PROJECT_DIR / "scripts/prepare_v26_parameter_sets.py",
        PROJECT_DIR / "scripts/run_v26_protocol_seed.py",
        PROJECT_DIR / "scripts/run_v26_development.py",
        PROJECT_DIR / "scripts/run_v26_dispatch_benchmark.py",
        FAMILY,
        *parameter_files,
    ]
    implementation.ANALYSIS_PATHS = [
        PROJECT_DIR / "scripts/analyze_v26_heterogeneous.py",
    ]
