...
"""Technical development replay for V25 before the prospective freeze."""
...
from run_v25_protocol_seed import (  # noqa: E402
    PROTOCOL_PATH,
    parameter_record,
    prepare_inputs,
)
...
SEED = 20261100
ROOT = PROJECT_DIR / "artifacts/V25_heterogeneous_validation/development/seed_20261100"
...
def main() -> None:
    ...
    if transition.get("source") != "history_transition_flags" or not bool(
        ...
        raise RuntimeError("V25 development risk inputs failed the causal gate")
    ...
    if not eligibility["eligible"]:
        raise RuntimeError("V25 development parameter unit is upstream-ineligible")
