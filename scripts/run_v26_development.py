...
"""Technical development replay for V26 before the prospective freeze."""
...
from run_v26_protocol_seed import (  # noqa: E402
    PROTOCOL_PATH,
    parameter_record,
    prepare_inputs,
)
...
SEED = 20261100
ROOT = PROJECT_DIR / "artifacts/V26_heterogeneous_validation/development/seed_20261100"
...
def main() -> None:
    ...
    if transition.get("source") != "history_transition_flags" or not bool(
        ...
        raise RuntimeError("V26 development risk inputs failed the causal gate")
    ...
    if not eligibility["eligible"]:
        raise RuntimeError("V26 development parameter unit is upstream-ineligible")
